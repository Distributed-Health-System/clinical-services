...
**Port:** 3003 | **Database:** MongoDB (`doctor_db`) | **Framework:** NestJS
...
```bash
docker build -t doctor-service:v1 .
docker run -p 3003:3003 --env-file .env doctor-service:v1
```
...
docker compose up doctor-service
```
