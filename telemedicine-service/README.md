...
**Port:** 3006 | **Database:** MongoDB (`telemedicine_db`) | **Framework:** NestJS
...
```bash
docker build -t telemedicine-service:v1 .
docker run -p 3006:3006 --env-file .env telemedicine-service:v1
```
...
docker compose up telemedicine-service
```
